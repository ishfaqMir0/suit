...
const Dashboard: React.FC = () => {
  const stats = [
    {
      title: 'Total Fields',
      value: mockDashboardStats.totalFields,
      icon: MapPin,
      color: 'text-blue-600',
      bgColor: 'bg-blue-50',
    },
    {
      title: 'Healthy Trees',
      value: mockDashboardStats.healthyTrees.toLocaleString(),
      icon: TreePine,
    ...
    {
      title: 'Active Alerts',
      value: mockDashboardStats.alerts,
      icon: AlertTriangle,
    ...
    {
      title: 'Weather',
      value: mockDashboardStats.weather,
      icon: Cloud,
